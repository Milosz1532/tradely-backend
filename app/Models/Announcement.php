...
{
    protected $fillable = ['title', 'description', 'price', 'user_id', 'category_id', 'subcategory_id', 'location', 'price_type', 'phone_number','latitude','longitude', 'province', 'product_state'];
